...
import { Mutation } from "../../model/CBioPortalAPI";
import {default as TableCellStatusIndicator, TableCellStatus} from "./functionPrediction/TableCellStatus";
import MutationAssessor from "./functionPrediction/MutationAssessor";
import {MutationAssessor as MutationAssessorData} from 'cbioportal-frontend-commons/api/generated/GenomeNexusAPI';
import Sift from "./functionPrediction/Sift";
import PolyPhen2 from "./functionPrediction/PolyPhen2";
import siftStyles from "./functionPrediction/siftTooltip.module.scss";
import polyPhen2Styles from "./functionPrediction/polyPhen2Tooltip.module.scss";
import mutationAssessorStyles from "./functionPrediction/mutationAssessorColumn.module.scss";
import annotationStyles from "./functionPrediction/annotation.module.scss";
...
interface IFunctionalImpactColumnFormatterProps {
    genomeNexusCache: VariantAnnotation | undefined;
}
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                >
                                    <img
                                        height={14} width={14}
                                        src={require("./functionPrediction/siftFunnel.png")}
                                        alt='SIFT'
                                    />
                                </span>
                            </th>
                            <th>
                                ...
                                >
                                    <img
                                        height={14} width={14}
                                        src={require("./functionPrediction/polyPhen-2.png")}
                                        alt='PolyPhen-2'
                                    />
                                </span>
                            </th>
...
export default class FunctionalImpactColumnFormatter extends React.Component<IFunctionalImpactColumnFormatterProps> {

    public render() {
        if (this.props.genomeNexusCache != undefined) {
            return FunctionalImpactColumnFormatter.renderFunction(this.props.genomeNexusCache);
        }
        else {
            return null;
        }
                ...
                <div style={{height:14}}>
                    ...
                    >
                        <span style={{display:'inline-block',width:22}}>
                            <img
                                height={14} width={14}
                                src={require("./functionPrediction/mutationAssessor.png")}
    ...
    public static renderFunction(
                                 genomeNexusCache:VariantAnnotation|null) {
        const genomeNexusCacheData = genomeNexusCache;
        return (
                <div>
    ...
    private static makeFunctionalImpactViz(genomeNexusCacheData:VariantAnnotation|null) {
        ...
        if (genomeNexusCacheData === null) {
            ...
            const functionalImpactData = FunctionalImpactColumnFormatter.getData(genomeNexusCacheData);
